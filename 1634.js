"use strict";(self.webpackChunkstructlife=self.webpackChunkstructlife||[]).push([[1634],{1634:(t,e,r)=>{r.r(e),r.d(e,{PhPlus:()=>c}),r(4687);var a=r(6058),h=r(5375),s=r(3588),i=r(1409),o=r(1893),l=Object.defineProperty,p=Object.getOwnPropertyDescriptor,n=(t,e,r,a)=>{for(var h,s=a>1?void 0:a?p(e,r):e,i=t.length-1;i>=0;i--)(h=t[i])&&(s=(a?h(e,r,s):h(s))||s);return a&&s&&l(e,r,s),s};let c=class extends h.WF{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var t;return a.qy`<svg
